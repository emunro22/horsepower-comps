// The free postal entry route, required for competitions to qualify under
// the skill/free-entry exemption rather than being an unlicensed lottery.
// This must be genuinely available and communicated as prominently as the
// paid route — see FREE_ENTRY_ADDRESS usages across competition pages, the
// entry flow, and Contact/Terms.
