...
// competition's sold count, and emails the customer. Shared between the
// Stripe webhook and manual (bank transfer) payment confirmation, since both
// ultimately do the same fulfillment once an order is known to be paid.
