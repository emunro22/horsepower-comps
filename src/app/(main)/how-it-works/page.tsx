...
const trustPoints = [
  ...
  { title: 'Registered Company', description: 'Horsepowercomps Ltd is a registered UK company operating fully within UK competition law. We take compliance seriously so you can enter with confidence.', icon: '📋' },
